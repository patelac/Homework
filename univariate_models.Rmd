...
The change in error distribution as you can see by the summary of the data showed the significant codes in important variables changed slightly. The variables themselves remained the same. In the anova analysis of variance table between two models, you can see the change in error distribution caused the residual sum of squares to decrease in both of the exploratory analysis models. The residual sum of squares were lower in General Linear Model (GLM) rather than in OLS.
